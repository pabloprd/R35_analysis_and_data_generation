...
setwd("/Users/paulparodi/R35_v2/Nanostring/R35_Nanostring_Data_Analysis/Output/Tables seperated by Metadata/")

Male_table <- read_excel("Sex_Male_Set1_genecounts_tables.xlsx")
Female_table <- read_excel("Sex_Female_Set1_genecounts_tables.xlsx")
Sex_full_table <- read_excel("/Users/paulparodi/R35_v2/Nanostring/R35_Nanostring_Data_Preprocessing/Output/Counts_with_metadata_markers/Sex_md_marker_normcounts.xlsx")

AA_table <- read_excel("Ancestry_black_Set1_genecounts_tables.xlsx")
EA_table <- read_excel("Ancestry_white_Set1_genecounts_tables.xlsx")
Ancestry_full_table <- read_excel("/Users/paulparodi/R35_v2/Nanostring/R35_Nanostring_Data_Preprocessing/Output/Counts_with_metadata_markers/Ancestry_md_marker_normcounts.xlsx")
...
GOI_function <- function(dataframe, gene){
  #dataframe
...
#Oxer1
Sex_OXER1 <- GOI_function(Sex_full_table, 'OXER1')
Single_gene_boxplot(Sex_OXER1, 'Sex','OXER1')


#CCL4
Sex_CCL4 <- GOI_function(Sex_full_table, "CCL4")
...
#Oxer1
Ancestry_OXER1 <- GOI_function(Ancestry_full_table, 'OXER1')
Single_gene_boxplot(Ancestry_OXER1, 'Ancestry','OXER1')


#CCL4
Ancestry_CCL4 <- GOI_function(Ancestry_full_table, "CCL4")
...
setwd("/Users/paulparodi/R35_v2/Nanostring/R35_Nanostring_Data_Visualization/Output/Boxplots/")
