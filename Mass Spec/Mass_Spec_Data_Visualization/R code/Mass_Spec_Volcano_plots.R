...
Sex_DEG <- read_xlsx("Mass_Spec_Data_Analysis/Output/Differential Gene Expression Tables/Male_vs_Female_DGE.xlsx")

#Ancestry differentially expressed genes
Ancestry_DEG <- read_xlsx("Mass_Spec_Data_Analysis/Output/Differential Gene Expression Tables/EA_vs_AA_DGE.xlsx")
